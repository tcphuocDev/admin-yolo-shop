  ...
  return /******/ (function (modules) {
    ...
    /******/ [
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var compressImage = (exports.compressImage = function compressImage(
          url
        ) {
          var width =
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        exports.default = {
          ...
          embed: "Nhúng",
          caption: "Chú thích",
          dragTip: "Nhấp hoặc kéo tệp vào đây",
          dropTip: "Thả chuột để tải lên",
          selectAll: "Chọn tất cả",
          deselect: "Bỏ chọn",
          removeSelected: "Xoá mục đã chọn",
          externalInputPlaceHolder: "Nhập đường dẫn",
          externalInputTip: "Mẹo đầu vào bên ngoài",
          addLocalFile: "Thêm tệp tin trên máy",
          addExternalSource: "Thêm tài nguyên bên ngoài",
          unnamedItem: "Không tên",
          confirmInsert: "Chèn mục đã chọn",
        };
        ...
        var BraftFinderView = (function (_React$Component) {
          ...
          function BraftFinderView(props) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (
                BraftFinderView.__proto__ ||
                Object.getPrototypeOf(BraftFinderView)
              ).call(this, props)
            );
            ...
            _this.toggleSelectItem = function (event) {
              ...
              if (item.selected) {
                if (
                  !_this.props.onBeforeDeselect ||
                  _this.props.onBeforeDeselect(
                    [item],
                    _this.controller.getItems()
                  ) !== false
                ) {
                  _this.controller.deselectMediaItem(itemId);
                  _this.props.onDeselect &&
                    _this.props.onDeselect([item], _this.controller.getItems());
                }
              } else {
                if (
                  !_this.props.onBeforeSelect ||
                  _this.props.onBeforeSelect(
                    [item],
                    _this.controller.getItems()
                  ) !== false
                  ...
                  _this.props.onSelect &&
                    _this.props.onSelect([item], _this.controller.getItems());
                }
              }
            };
            ...
            _this.removeItem = function (event) {
              ...
              if (
                ...
                _this.props.onRemove &&
                  _this.props.onRemove([item], _this.controller.getItems());
              }
            ...
            _this.selectAllItems = function () {
              ...
              if (
                !_this.props.onBeforeSelect ||
                _this.props.onBeforeSelect(allItems, allItems) !== false
              ) {
                _this.controller.selectAllItems();
                _this.props.onSelect &&
                  _this.props.onSelect(allItems, allItems);
              }
            };
            ...
            _this.deselectAllItems = function () {
              ...
              if (
                !_this.props.onBeforeDeselect ||
                _this.props.onBeforeDeselect(allItems, allItems) !== false
              ) {
                _this.controller.deselectAllItems();
                _this.props.onDeselect &&
                  _this.props.onDeselect(allItems, allItems);
              }
            };
            ...
            _this.reslovePickedFiles = function (event) {
              ...
              var _ref =
                  event.type === "drop" ? event.dataTransfer : event.target,
                files = _ref.files;
            ...
            _this.confirmAddExternal = function (event) {
              if (
                ...
                url = url.split("|");
                var name =
                  url.length > 1 ? url[0] : _this.props.language.unnamedItem;
            ...
            _this.changeListenerId = _this.controller.onChange(function (
              items
            ) {
              _this.setState({
                items: items,
                            ...
                            _react2.default.createElement(
                              ...
                              _react2.default.createElement(
                                ...
                                _react2.default.createElement("input", {
                                  ...
                                  placeholder:
                                    language.externalInputPlaceHolder,
                                })
                              ),
                              _react2.default.createElement(
                                "button",
              ...
              value: function buildItemList() {
                ...
                return _react2.default.createElement(
                  ...
                  this.state.items.map(function (item, index) {
                    ...
                    var progressMarker =
                      item.uploading && !_this2.props.hideProgress
                        ? _react2.default.createElement(
                            "div",
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var _initialiseProps = function _initialiseProps() {
          ...
          this.addItems = function (items) {
            _this.items = [].concat(
              _toConsumableArray(_this.items),
              _toConsumableArray(
                items.map(function (item) {
                  return _extends({}, item, { id: item.id.toString() });
                })
          ...
          this.createThumbnail = function (_ref) {
            ...
            (0, _image.compressImage)(URL.createObjectURL(file), 226, 226).then(
              function (result) {
            ...
            if (files[index] && files[index].type.indexOf("image") > -1) {
              _this.uploadImage(files[index], function (image) {
                ...
                index < files.length - 1 &&
                  _this.uploadImageRecursively(files, callback, index + 1);
              });
            } else {
              index < files.length - 1 &&
                _this.uploadImageRecursively(files, callback, index + 1);
          ...
          this.addResolvedFiles = function (param, index, accepts) {
            ...
            if (
              param.files[index].type.indexOf("image/") === 0 &&
              accepts.image
            ) {
              data.type = "IMAGE";
          ...
          this.offChange = function (listenerId) {
            _this.changeListeners = _this.changeListeners.filter(function (
              _ref3
            ) {
              var id = _ref3.id;
        ...
        var BraftFinder = (function (_FinderController) {
          ...
          function BraftFinder(props) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (
                BraftFinder.__proto__ || Object.getPrototypeOf(BraftFinder)
              ).call(this, props)
            );
          ...
          this.ReactComponent = function () {
            ...
            var language =
              (typeof componentProps.language === "function"
                ? componentProps.language(_languages2.default, "braft-finder")
                : _languages2.default[componentProps.language]) ||
              _languages2.default["zh"];
